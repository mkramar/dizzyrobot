...
#define MQTT_MAX_PUBREL_INFLT 32 /* Must be kept as a value of 2^n */
...
{ 
    uint16_t idVec[MQTT_MAX_PUBREL_INFLT];  /* Vector to store RX Message-IDs */
    uint8_t  nFree;                    /* Num of free elements in vector */
    uint8_t  rdIdx;                    /* Index to Read  next Message-ID */
    uint8_t  wrIdx;                    /* Index to Write next Message-ID */
