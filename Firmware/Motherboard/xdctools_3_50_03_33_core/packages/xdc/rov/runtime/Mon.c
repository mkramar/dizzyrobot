 ...
 *
 *  Commands suported:
 *      "r <addr>,<cnt>"  - copy <cnt> bytes from <addr> and write them
 *      "w <addr>,<cnt>"  - read <cnt> bytes and copy them to <addr>
 *      "c <addr>,<cnt>"  - crc32 <cnt> bytes from <addr> and write 4-byte
 *                          binary CRC32
 *
