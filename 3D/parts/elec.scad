...
module boardHolderPlus() {
	x = 35;
	y = 17.2;
	
	translate([-x/2, -y/2, 0]) boardHolderLeg();
	translate([+x/2, +y/2, 0]) rotate([0, 0, 180]) boardHolderLeg();
}

module boardHolderMinus() {
	x = 35;
	y = 17.2;
	
	translate([-x/2, -y/2, 0]) nutMinus();
	translate([+x/2, +y/2, 0]) nutMinus(20);
}
